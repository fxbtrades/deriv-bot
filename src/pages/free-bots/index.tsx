...
const BOTS: Bot[] = [
    ...
    {
        id: '13',
        name: 'Premium Acc MACD BB Bot v1',
        description: 'Accumulator bot using MACD, Bollinger Bands, RSI and DEMA indicators with session risk controls.',
        fileName: '2026_Premium_Acc_MACD_BB_Bot_v1_1780371945082.xml',
        category: 'Accumulators',
        icon: '📊',
    },
    {
        id: '14',
        name: 'Premium ME Differs Trading v1',
        description: 'Matches Encroachment digit trading bot with Martingale recovery and window-based analysis.',
        fileName: '2026_Premium_MEDTv1_1780371945082.xml',
        category: 'Differ',
        icon: '🎯',
    },
    {
        id: '15',
        name: 'Premium ME Differs Trading v2',
        description: 'Upgraded Matches Encroachment differ bot with wider top gap tolerance for improved entries.',
        fileName: '2026_Premium_MEDTv2_1780371945082.xml',
        category: 'Differ',
        icon: '🎯',
    },
    {
        id: '16',
        name: 'Premium ME Matches Trading v1',
        description: 'Matches Encroachment bot targeting match contracts with smart threshold filtering.',
        fileName: '2026_Premium_MESTv1_1780371945082.xml',
        category: 'Pattern Analysis',
        icon: '🔍',
    },
    {
        id: '17',
        name: 'Premium ME Matches Trading v2',
        description: 'Higher-stake version of the Matches Encroachment bot with refined threshold settings.',
        fileName: '2026_Premium_MESTv2_1780371945082.xml',
        category: 'Pattern Analysis',
        icon: '🔍',
    },
    {
        id: '18',
        name: 'Premium ME URF Verified',
        description: 'Verified Matches Encroachment bot tuned for Volatility 100 Index with multi-step Martingale.',
        fileName: '2026_Premium_MEURF_verified_O1_1780371945082.xml',
        category: 'Pattern Analysis',
        icon: '✅',
    },
    {
        id: '19',
        name: 'Premium Matches Encroachment v1',
        description: 'Original Matches Encroachment strategy bot for Volatility 100 Index with digit frequency analysis.',
        fileName: '2026_Premium_MEv1_1780371945082.xml',
        category: 'Pattern Analysis',
        icon: '📈',
    },
    {
        id: '20',
        name: 'Premium Matches Encroachment v2',
        description: 'Enhanced Matches Encroachment bot for Volatility 10 Index with top-gap filtering.',
        fileName: '2026_Premium_MEv2_1780371945082.xml',
        category: 'Pattern Analysis',
        icon: '📈',
    },
];
